 ...
 */
public class ReplicationMockWebServerTest extends LiteTestCaseWithDB {
    /**
     ...
     */
    private Map<String, Object> mockMultiplePull(boolean shutdownMockWebserver, MockDispatcher.ServerType serverType) throws Exception {
    ...
    private Map<String, Object> mockContinuousPull(boolean shutdownMockWebserver, MockDispatcher.ServerType serverType) throws Exception {
     ...
     */
    private Map<String, Object> mockSinglePush(boolean shutdownMockWebserver, MockDispatcher.ServerType serverType) throws Exception {
    ...
    public void testContinuousPushReplicationGoesIdle() throws Exception {
        ...
        try {
            ...
            Replication firstPusher = database.createPushReplication(server.url("/db").url());
            ...
            Replication secondPusher = database.createPushReplication(server.url("/db").url());
    ...
    public void runPushReplicationWithTransientError(String status, boolean expectReplicatorError) throws Exception {
        ...
        try {
            ...
            // run replication
            Replication pusher = database.createPushReplication(server.url("/db").url());
    ...
    public void testGoOfflinePusher() throws Exception {
        ...
        try {
            ...
            try {
                ...
                // 2. Kick off continuous push replication
                Replication replicator = database.createPushReplication(server.url("/db").url());
    ...
    public void testGetReplicatorWithCustomHeader() throws Throwable {
        ...
        try {
            ...
            targetProperties.put("url", server.url("/db").url().toExternalForm());
            ...
            assertEquals(server.url("/db").url().toExternalForm(),
    ...
    public void testGetReplicator() throws Throwable {
        ...
        try {
            ...
            Map<String, Object> properties = new HashMap<String, Object>();
            properties.put("source", DEFAULT_TEST_DB);
            properties.put("target", server.url("/db").url().toExternalForm());

            Replication replicator = manager.getReplicator(properties);
            assertNotNull(replicator);
            assertEquals(server.url("/db").url().toExternalForm(), replicator.getRemoteUrl().toExternalForm());
            assertTrue(!replicator.isPull());
            assertFalse(replicator.isContinuous());
            assertFalse(replicator.isRunning());
    ...
    public void test17_RemovedRevision() throws Exception {
        ...
        try {
            ...
            Replication push = database.createPushReplication(server.url("/db").url());
    ...
    public void test18_PendingDocumentIDs() throws Exception {
        ...
        try {
            ...
            // pull replication
            repl = database.createPullReplication(server.url("/db").url());
    ...
    public void testPullReplicationSetDocumentIDs() throws Exception {
        ...
        try {
            ...
            // Run pull replication:
            Replication replication = database.createPullReplication(server.url("/db").url());
            replication.setDocIds(Arrays.asList(new String[]{"doc2", "doc3"}));
            runReplication(replication);
    ...
    public void testPushReplActiveState() throws Exception {
        ...
        try {
            ...
            //
            Replication pullReplication = database.createPushReplication(server.url("/db").url());
            pullReplication.setContinuous(true);
    ...
    public void testSetFilterParams() throws CouchbaseLiteException, IOException, InterruptedException {
        ...
        try {
            ...
            Replication pushReplication = database.createPushReplication(server.url("/db").url());
    ...
    public void testContinuousPullReplicationGoesIdleTwice() throws Exception {
        ...
        try {
            ...
            // create pull replication
            final Replication pullReplication = database.createPullReplication(server.url("/db").url());
            pullReplication.setContinuous(true);
    ...
    private static Object str2json(String value) {
        Object result = null;
        try {
    ...
    private static Map<String, String> query2map(String queryString) {
